...
public class ComparitorGoogleAndWiki {
    ...
    public  void testGoogleExercise() throws IOException {
        ...
        java.io.InputStream is = this.getClass().getResourceAsStream("my.properties");          //hier kan hij niets laden
        java.util.Properties p = new Properties();
        p.load(is);
        String name = p.getProperty("domain.name");
